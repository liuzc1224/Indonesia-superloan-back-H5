...
<script>
  import { convertProduct,convertProductExport } from '@/api/reportCenter'
    ...
    export default {
      ...
      data(){
        return {
          ...
          columns: [
            {
              title: this.$t('operationalData.productDimension.data'), key: 'dateStr', align: 'center', tooltip: true, minWidth:150
            },
            {
      ...
      methods:{
        ...
        getTable(){
          ...
          convertProduct(params).then(res => {
