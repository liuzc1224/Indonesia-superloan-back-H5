<template>
  <Row>
    ...
    <Card style="margin-top: 10px">
      <Table border class="person-table" :key="'grandTotal'" :columns="columns" :data="tableData" :loading="tableLoading1" style="margin-top: 10px"/>
...
<script>
  import { promotionconversionSummary ,promotionconversionSummaryExport,platformName} from '@/api/reportCenter'
  ...
  export default {
    ...
    methods: {
      ...
      getTable(){
        ...
        this.tableLoading1 = this.tableLoading1 === false ? true : this.tableLoading1;
        promotionconversionSummary(params).then(res => {
      ...
      exportData(){
        ...
        promotionconversionSummaryExport(params);
      },
      changeSelect($event){
        let id=$event;
